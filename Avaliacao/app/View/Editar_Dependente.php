...
<form action="<?php Ambiente::getUrl('Dependente/atualizar',true)?>?id=<?php echo $aDependente[0]->getIdDependente()?>" method="post">
    ...
    <div>
        ...
        <select name="parentesco">
            ...
            <option value="Pai" <?php echo $aDependente[0]->getGrauParentesco() == 'Licenciado' ? 'selected' : ''; ?>>Pai</option>
            <option value="Mae" <?php echo $aDependente[0]->getGrauParentesco() == 'Licenciado' ? 'selected' : ''; ?>>Mae</option>
        </select>
    </div>
